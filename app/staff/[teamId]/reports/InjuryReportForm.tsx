    ...
    <div className="flex flex-col gap-6">
      <form onSubmit={onSubmit} className={FORM_GRID} noValidate>
        ...
        <p className="text-sm" style={{ color: "var(--text-muted)" }}>
          ...
          clinical detail. Injuries sustained before the period but still unresolved during it are
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="inj_period_start" className={labelClass} style={{ color: "var(--text)" }}>
              Period start
            </label>
            <input
              id="inj_period_start"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="inj_period_end" className={labelClass} style={{ color: "var(--text)" }}>
              Period end
            </label>
            <input
              id="inj_period_end"
        ...
        <div className="col-span-full flex flex-col gap-1.5">
          <label htmlFor="inj_instructions" className={labelClass} style={{ color: "var(--text)" }}>
      ...
      {state.reportId && (
        <GeneratedReportViewer
          ...
          title={`Injury / RTP — ${selected ? `${selected.first_name} ${selected.last_name}` : "Athlete"}`}
